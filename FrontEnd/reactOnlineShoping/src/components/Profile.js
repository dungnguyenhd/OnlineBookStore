...
export default function Profile() {
    ...
    const bro= useContext(UserContext);
    // useEffect(()=>{
    //     setUser(props.data);
    // }, [props.data]);
                            ...
                            <div className="card-body">
                                ...
                                <div className="row">
                                    <div className="col-sm-12">
                                        <button className="btn btn-info " target="__blank" href="https://www.bootdey.com/snippets/view/profile-edit-data-and-skills"> <i class="fas fa-save"></i> Lưu thông tin</button>
                                        <button className="btn btn-danger ms-2 " target="__blank" href="https://www.bootdey.com/snippets/view/profile-edit-data-and-skills"> <i class="fas fa-store"></i> Cửa hàng của tôi</button>
                                    </div>
                                </div>
                            </div>
                        </div>
